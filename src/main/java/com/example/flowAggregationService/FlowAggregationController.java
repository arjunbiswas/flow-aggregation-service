...
public class FlowAggregationController {
	 ...
	 * @param hour The value for the hour you want to look up. Valid hour values are integers starting from 1.
	 * @return a json array containing aggregated bytes_tx and bytes_ry for every (src_app + dest_app + vpc_id + hour) tuple
	 */
